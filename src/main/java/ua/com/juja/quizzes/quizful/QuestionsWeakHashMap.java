 ...
 */
public class QuestionsWeakHashMap {
    public static void main(String[] args) {
    /*Из какой структуры данных "сборщик мусора" удалит все элементы
    у которых исчезла последняя ссылка на их ключ в этой структуре?*/
//    WeakHashMap !!!
    /*Пояснение:
...
Перед любым обращением к WeakHashMap (get(), put(), size() и т.д.)
анализируются невалидные ссылки и соответствующая пара удаляется.
